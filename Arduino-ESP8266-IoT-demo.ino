...
void sendTemperature(float temperature) {
  ...
  mySerial.println("AT+CWJAP=\"Dirks Draadloos\",\"DirkUit1991\"");
  if (WaitForOK(5000)) {
  ...
  WaitForOK(5000);
  mySerial.print("GET /input/zD0AyAo84RiNb1dMLXzw?private_key=Yy6lKlxkVetv8o6bpJEZ&temp=" + String(temperature) + " HTTP/1.0\r\n");
